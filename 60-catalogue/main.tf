...
resource "terraform_data" "catalogue" {
  triggers_replace = [ # it will trigger once after the above mongodb instance created
...
resource "terraform_data" "catalogue_delete" {
 ...
 #Here make sure aws configure in our laptop as it is running from local
