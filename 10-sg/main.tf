module "frontend" {
  ...
  source = "git::https://github.com/Practice-daws84s/terraform-aws-securitygroup.git?ref=main"
  project = var.project
...
# backend ALB accepting connections from my bastion host on post no 80
